...
const FooterNew = () => {
  return (
    <section className="h-[100dvh] bg-black snap-start relative overflow-hidden flex flex-col space-y-7 justify-center items-center">
      <div className="flex flex-row justify-center items-center gap-5">
        <button
          className={`p-5 py-3 flex items-center justify-center gap-3 border-[1px] border-white rounded-md`}
        >
          <img src="/assets/apple-green.png" alt="Apple icon" className="w-4" />
          <div className={`text-white font-Agrandir text-[9px]`}>APP STORE</div>
        </button>
        <button
          className={`p-5 py-3 flex items-center justify-center gap-3 border-[1px] border-white rounded-md`}
        >
      ...
      <div className="flex flex-col gap-8 items-center justify-center w-[86dvw]">
        <div>
          <h1 className="sm:text-xl text-white font-Agrandir text-[16px]">
            Policy terms
          </h1>
          <p className="md:w-[350px] w-[86dvw] text-white font-Mulish text-sm sm:text-base sm:w-[300px]">
